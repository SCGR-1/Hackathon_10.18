export type CredentialType = 'VisaCredential' | 'EducationCredential' | 'CertificationCredential'
...
export const CREDENTIAL_TYPES = {
  ...
  [SCHEMA_CODES.CERTIFICATION]: 'CertificationCredential'
} as const
...
export function getSchemaCode(credentialType: CredentialType): number {
  switch (credentialType) {
    ...
    case 'CertificationCredential': return SCHEMA_CODES.CERTIFICATION
